...
> **112 dated entries · 2026-06-30 → 2026-08-16 · refreshed 2026-08-17 17:01 PDT**
>
...
**2026-06**
- `2026-06-30` `L385` 2026-06-30 (ingested 7/10) — Hammack: the FIRST rung, and the Warsh split goes public
- `2026-06-30` `L386` DATA (`raw/2026-06-30-hammack-ai-inflation-cnbc.md`, CNBC Sintra interview, Hammack = 2026 VOTER)
**2026-07**
- `2026-07-01` `L169` Post-COVID (2022-base) — wages, energy, frozen labor (added 2026-07-01)
- `2026-07-01` `L194` Bottom basket vs CPI — the deflator test (added 2026-07-01)
- `2026-07-01` `L218` Warsh / Fed Trap update (2026-07-01, Sintra) — HAWKISH, corrects the intraday "dovish" read
- `2026-07-01` `L233` ⚠️ Debasement-unwind headwind (2026-07-01, Goldman via ZH Korea note)
- `2026-07-02` `L242` June-2026 jobs — Hollow Bottom confirmed, Fed Trap deepened (2026-07-02)
- `2026-07-08` `L268` FOMC minutes 2026-07-08 — the Fed names AI; the doom loop documented
- `2026-07-09` `L282` Warsh's task forces (2026-07-09, Fed press release — primary source, Jake paste)
- `2026-07-10` `L316` The layoffs-vs-jobs-numbers reconciliation (permanent explainer, 2026-07-10)
- `2026-07-10` `L344` 2026-07-10 addendum — GS puts a number on the Fed's "AI-related price pressures"
- `2026-07-10` `L355` 2026-07-10 — Williams goes on record: AI demand could FORCE hikes (the troika speaks)
- `2026-07-10` `L356` DATA (`raw/2026-07-10-williams-ai-demand-hikes.md`, Bloomberg 7/9)
- `2026-07-10` `L420` ⚠️ RESOLVED (2026-07-10, WebSearch vs actual June SEP) — the dot-plot discrepancy
- `2026-07-10` `L438` 2026-07-10 — housing bill held hostage (Jake detail: supply-side cost-reduction bill; Trump won't
- `2026-07-11` `L450` 2026-07-11 — debt math logged: +$2.99T/yr, interest ~$1.2T/yr (ZH 5-charts)
- `2026-07-12` `L459` 2026-07-12 — Jake's "inflate it away" scenario: the policy valve as the answer to the well-duh riddle
- `2026-07-12` `L497` 2026-07-12 — the 2026 YTD run-rate (Jake's Q: "on the year, not the sum of the parts")
- `2026-07-12` `L523` 2026-07-12 — the THIRD exit: redefine the yardstick (Jake's thesis — VERIFIED as announced program)
- `2026-07-12` `L569` 2026-07-12 — the LABOR leg of the third exit (Jake's extension: "wages > inflation" by composition)
- `2026-07-12` `L610` 2026-07-12 — the FISCAL ledger (Jake: "it shows up in SS, SNAP and housing subsidies")
- `2026-07-12` `L644` 2026-07-12 ~10pm PT — Timiraos pre-testimony frame: a JULY HIKE is in play; Williams sets a
- `2026-07-12` `L646` DATA (`raw/2026-07-12-timiraos-warsh-first-call.md` — WSJ full text)
- `2026-07-13` `L679` 2026-07-13 ~11:45am PT — WALLER, CPI EVE: "near-term hike possible" — Treasuries fall, GOLD −3%
- `2026-07-13` `L691` 2026-07-13 ~1:15pm PT — the WALCL chart + Waller's defense: the two-handed policy, quantified
- `2026-07-13` `L716` 2026-07-13 ~5:30pm PT — prediction market prices July FOMC: 66% hold / 34% hike (Jake's print)
- `2026-07-13` `L747` 2026-07-13 ~5:50pm PT — AI cost-push INTO the CPI: the channel map (Jake's Q: "electronics, autos, etc.")
- `2026-07-14` `L812` 2026-07-14 ~4:28am PT — Ericsson refines the AI-inflation channel map: pricing power decides CPI-vs-margin
- `2026-07-14` `L832` 2026-07-14 ~5:30am PT — CPI PRINTS COLD: core 0.0% below the tripwire (the relief branch)
- `2026-07-14` `L945` 2026-07-14 ~5:55am PT — "money about to rip again?" (Jake: mini-cycle-within-the-cycle)
- `2026-07-14` `L997` 2026-07-14 ~8:47am PT — rate-hike odds: soft CPI knocked them down but SMART money holds them up
- `2026-07-14` `L1019` 2026-07-14 ~7pm PT — Gundlach: 30Y at 5.10% bumping ~2-decade-high resistance, "unlikely to hold"
- `2026-07-14` `L1037` 2026-07-14 ~8:30pm PT — Warsh FULL testimony (primary source): the third-exit machinery, stated
- `2026-07-14` `L1038` DATA (observed) — raw/2026-07-14-warsh-house-testimony-full.md (federalreserve.gov)
- `2026-07-14` `L1070` 2026-07-14 ~8:40pm PT — Jake's SIGN-FLIP insight: in THIS regime, HIKING is the "for the people" move
- `2026-07-15` `L1113` 2026-07-15 ~7:14am PT — PPI soft → July hike off the table → runway EXTENDS (but energy-led again)
- `2026-07-15` `L1132` 2026-07-15 — Beige Book (July): the margin-vs-price tell RESOLVES "margins, not prices — so far"
- `2026-07-16` `L1163` 2026-07-16 eve — Fed turns HAWKISH; long end UP → cuts against the back-door-easing bull
- `2026-07-17` `L1172` 2026-07-17 ~11:50pm PT — Labor market FREEZING (JOLTS-vs-hiring); a viral "cover-up" claim, filtered
- `2026-07-17` `L1204` 2026-07-17 ~7:13am PT — UMich sentiment bounce is a STALE truce-window snapshot (survey timing trap)
- `2026-07-18` `L1231` 2026-07-18 ~7:54am PT — foreclosures +21% H1 but STILL below normal: warning, not crisis (base-rate trap)
- `2026-07-19` `L1252` 2026-07-19 ~10pm PT — "Financial gravity" (SPX / Fed balance sheet): the debasement spine, and its honest bounds
- `2026-07-19` `L1282` RESULT — financial_gravity.ipynb run (Jake, 2026-07-19 ~10pm PT). Prior CONFIRMED; thesis upgraded to M2.
- `2026-07-23` `L1305` 2026-07-23 ~8:35am PT — tariffs = a SECOND inflation input stacking on oil into a boxed Fed (higher-for-longer reinfor
- `2026-07-23` `L1328` 2026-07-23 ~8:50am PT — Jake's run-hot/debasement synthesis (+ the jobless-claims correction + the tariff-dollar Triff
- `2026-07-23` `L1354` 2026-07-23 ~9am PT — the TWO dollar values (why "strong $" and inflation coexist) [Jake's Q]
- `2026-07-23` `L1368` 2026-07-23 ~9:05am PT — the trade deficit IS the foreign debt financing (the identity that collapses the policy) [Jake
- `2026-07-23` `L1386` 2026-07-23 ~9:35am PT — higher-for-longer hits the REAL economy: mortgage rates + bond yields at highs (Jake)
- `2026-07-23` `L1400` 2026-07-23 ~10:40am PT — Treasury repo investment facility "increasingly likely" (Barclays) = fiscal dominance in the 
- `2026-07-23` `L1418` 2026-07-23 ~11:15am PT — REGIME SHIFT: market flips to pricing HIKES, tracking oil TICK-FOR-TICK (oil = monetary polic
- `2026-07-23` `L1440` 2026-07-23 ~2:30pm PT — tariff SWAP confirmed (grades AM call): forced-labor 10-12.5% REPLACES the lapsed surcharge
- `2026-07-24` `L1454` 2026-07-24 ~10:41AM PT — Trump: US starting a SECTION 301 PROBE into "EU actions on US tech" (ZH, 6m)
- `2026-07-24` `L1467` 2026-07-24 ~11:28AM PT — primary source: Trump's actual Truth Social post on the 301/EU probe (confirms + quantifies t
- `2026-07-26` `L1477` 2026-07-26 ~8:40pm PT — Jake's thought experiment: could a punitive wealth/corporate tax trigger bond dumping that "re
- `2026-07-29` `L1544` 2026-07-29 ~11:00am PT — ★★★ FOMC: 9-3 HOLD AT 3.50-3.75% WITH **THREE DISSENTS IN FAVOUR OF A HIKE**
- `2026-07-29` `L1604` 2026-07-29 ~11:15am PT — ★★ CURVE STEEPENS POST-FOMC — and IF it is the bear variety, it is the macro price of the fin
- `2026-07-29` `L1644` 2026-07-29 ~11:20am PT — ★★★ THE STATEMENT REDLINE: WARSH DELETED FORWARD GUIDANCE, CALLED ENERGY A SUPPLY SHOCK, AND 
- `2026-07-29` `L1711` 2026-07-29 ~11:20am PT — ★★★ 30Y +10bp TO 5.19%. THE FORK RESOLVES TO BEAR STEEPENING — AND WARSH SAYS HE ENGINEERED T
- `2026-07-29` `L1776` 2026-07-29 ~10:55pm PT — ⛔ MY DISSENT RETRACTION WAS TOO COMPLETE: it is the most early dissent since 1970, and Warsh 
- `2026-07-30` `L1807` 2026-07-30 ~8:30am ET — JUNE PCE: core soft by a rounding step, y/y EXACTLY in line — and the non-obvious read is that
- `2026-07-30` `L1839` 2026-07-30 ~8:35am ET — THE FULL 8:30 SET: this is a SLOWDOWN, not stagflation — and the number that matters is not in
- `2026-07-30` `L1881` 2026-07-30 ~8:45am ET — ⛔ CORRECTION: CORE PCE WAS **−0.1%**, NOT +0.1% (Jake's catch) — and the likely mechanical cau
- `2026-07-30` `L1916` 2026-07-30 ~8:55am ET — ⛔⛔ THE PREVIOUS ENTRY IS SUPERSEDED AND WRONG: core PCE WAS +0.1%. I accepted a bad correction
- `2026-07-30` `L1952` 2026-07-30 ~9:05am ET — ⚠️ A REAL ALTERNATIVE TO MY OWN 30Y CALL: the long end may be FORWARD-looking, not credibility
- `2026-07-30` `L1973` 2026-07-30 ~9:30am ET — "WHAT HAPPENS WHEN THE 30Y GOES ABOVE 5%?" (Jake) — the question cannot be answered as posed, 
- `2026-07-30` `L2006` 2026-07-30 ~9:00am ET — 20s30s IS INVERTED (Jake's screen, Jul-30 8:58am ET) — but it is a CONVEXITY signal, not a gro
- `2026-07-30` `L2049` 2026-07-30 ~9:45am ET — ★★★ THE 30Y STUDY RAN: speed is the real variable, and PANEL D INVERTS WHAT I IMPLIED
- `2026-07-30` `L2105` 2026-07-30 ~4:35pm PT — ⛔ BACKFILL: "S&P LOWERS RATINGS ON 21 IA SCHOOL DISTRICTS" — answered in chat, NEVER FILED
- `2026-07-30` `L2149` 2026-07-30 ~4:50pm PT — "SEEMS INFLATIONARY" (Jake, on the Graham Act) — yes, and it is the WRONG KIND
- `2026-07-30` `L2181` 2026-07-30 ~4:55pm PT — ★★ THE US-DOMESTIC INFLATION CHAIN, which is what Jake was actually asking about
- `2026-07-31` `L2197` 2026-07-31 ~7:12pm PDT — ★★ A FOURTH FED VOICE FOR HIKES: MUSALEM (St. Louis) TO THE FT
- `2026-07-31` `L2258` 2026-07-31 ~10:13pm PDT — M2 CHART (Jake) × THE ABSENT-FED QUESTION: ⛔ HE WAS RIGHT AND I ANSWERED THE WEAKER VERSION
**2026-08**
- `2026-08-01` `L2234` 2026-08-01 ~04:56 UTC — ⚠️ WARSH WEIGHING FEWER FOMC MEETINGS: this hits MY OWN KILL SWITCH
- `2026-08-01` `L2314` 2026-08-01 ~11:15pm PDT — ★★★ NY FED DESK SCHEDULE: THE FED *IS* BUYING (I WAS WRONG) — AND THE TAPER IS THE BEST FED 
- `2026-08-01` `L2368` ★★★ KILL SWITCH — REPLACES BOTH FAILED ONES (registered 2026-08-01)
- `2026-08-02` `L2384` 2026-08-02 ~5:20pm PDT — ★★★ WHY BESSENT AND NOT THE FED: the yen defence is LONG-END POLICY
- `2026-08-03` `L2440` 2026-08-03 ~Asia open (filed 8/2 ~8:25pm PDT) — ⛔ THE BOJ ALREADY HIKED: my chain was backwards, and the REPO FACILITY
- `2026-08-03` `L2500` 2026-08-03 ~5:03am ET (filed ~7:55am PT) — ★★★ FIMA NAMED: the "Japan as forced UST seller" thesis is DEAD
- `2026-08-05` `L2560` 2026-08-05 ~12:55am PDT — ★★★ YIELD-EQUITY CORRELATION −0.48, REPORTED MOST NEGATIVE SINCE 1999 — the fiscal-dominance
- `2026-08-05` `L2608` 📌 2026-08-05 ~10:50am PDT — TRANSMISSION LEDGER: mortgage applications fall as rates spike (Axios, headline only)
- `2026-08-05` `L2615` 2026-08-05 ~12:55pm PDT — JUNE JOLTS, THE COMPLETE RECORD: the breakdown names WHO stopped posting — and the paste's o
- `2026-08-06` `L2658` 2026-08-06 ~9:00am PDT — ★★★ WARSH SAYS THE QUIET PART: "MARKETS HAVE MADE DECISIONS BECAUSE WE STEPPED BACK" — the te
- `2026-08-06` `L2703` 2026-08-06 ~8:55am PDT — ★★★ ONE FLOW, BOTH ENDS, ONE MORNING: the 2nd-LARGEST YEN OPERATION IN HISTORY ($85bn, GS) bo
- `2026-08-06` `L2740` 2026-08-06 ~12:20pm PDT — HANDOFF: **TIC SHOWS JAPAN SOLD $96B OF TREASURIES FEB→MAY** — the FIMA-pledge thesis takes 
- `2026-08-06` `L2764` 2026-08-06 ~6:25pm PDT — MoF QUARTERLY DATA: the two-bar ambiguity RESOLVES, the TIC mechanism CONFIRMS — and the new 
- `2026-08-07` `L2799` 2026-08-07 ~7:45am PDT — THE STAGFLATION SQUEEZE PRINTS: payrolls −23k into ISM prices >70 — pointer
- `2026-08-07` `L2810` 2026-08-07 ~7:50am PDT — ★★★ THE CROSS-THREAD JOIN: **THE DOLLAR DID FOR FREE WHAT $85 BILLION COULD NOT**
- `2026-08-07` `L2824` 2026-08-07 ~12:50pm PDT — ★★★★ Q2 PRODUCTIVITY +1.4% / ULC +1.3%: **THE HEADLINE FAILS ITS OWN CHART** — and the wage-
- `2026-08-09` `L3725` DATA (REPORTED — the piece's figures, dated 2026-08-09 unless noted)
- `2026-08-11` `L2896` 2026-08-11 ~1:00pm PDT — 📌 THE PAYROLL-REVISION POST: the −103k is FOUR DAYS OLD AND ALREADY FILED. The genuinely new 
- `2026-08-11` `L2945` 2026-08-11 ~4:50pm PDT — 📌 THE RATES-VOL SURFACE ENTERS THE VAULT: 3y10y payer skew at multi-year highs, vol-of-vol ne
- `2026-08-11` `L2996` 2026-08-11 ~5:25pm PDT — ★★★★ BofA's OBSERVATION IS CONFIRMED 11:1 AND ITS MECHANISM IS UNTESTED — plus the rate data 
- `2026-08-11` `L3002` DATA (observed — BLS public API, pulled 2026-08-11, participation rate %)
- `2026-08-12` `L3052` 2026-08-12 ~8:45am PDT — ⛔⛔⛔ I HAD THE FED BACKWARDS ALL SESSION: THE 44-45% IS **HIKE** ODDS, NOT CUT ODDS. And it ma
- `2026-08-12` `L3071` DATA (observed — 2026-08-12)
- `2026-08-12` `L3125` 2026-08-12 ~10:20am PDT — ★★★★★ THE CPI DETAIL RESOLVES THE HIKE-ODDS PUZZLE: THE FED TARGETS PCE, AND CORE PCE IS 3.3
- `2026-08-12` `L3179` 2026-08-12 ~10:30am PDT — ★★★★★ THE INTERVENTION ROUND-TRIPPED ON PRICE AND SUCCEEDED ON POSITIONING — which DOWNGRADE
- `2026-08-12` `L3494` DATA (MEASURED — as of 2026-08-12 unless noted)
- `2026-08-13` `L3230` 2026-08-13 ~6:45am PDT — ★★★★★★ THE PPI PRINTS **+0.4% CORE — EXACTLY THE VAULT'S PRE-REGISTERED NUMBER, DOUBLE CONSEN
- `2026-08-13` `L3294` 2026-08-13 ~8:10am PDT — ⛔⛔⛔ **I GOT THE PPI BACKWARDS AN HOUR AGO. IT PRINTED COOLER THAN EXPECTED ON EVERY MEASURE T
- `2026-08-13` `L3359` 2026-08-13 ~10:55am PDT — ★★★★★ THE 30Y AUCTION CLOSES THIS MORNING'S REGISTERED ITEM — **and the headline fuses two d
- `2026-08-13` `L3424` 2026-08-13 ~11:00am PDT — ★★★★★ JAKE'S FULL-WEEK REFUNDING READ IS CORRECT — and the three prints together carry **THR
- `2026-08-13` `L3486` 2026-08-13 ~12:55pm PDT — ⛔ **THE 30Y SPLIT ANSWERS THE TOP MACRO ITEM AND IT REFUTES MY INFLATION-TOLERANCE READ: IT 
- `2026-08-14` `L3543` 2026-08-14 ~7:45am PDT — ★★★★★★★ THE VAULT PRE-REGISTERED THIS PRINT AND SIZED THE ARTIFACT — the calendar effect cove
- `2026-08-14` `L3623` 2026-08-14 ~7:55am PDT — ⛔⛔⛔ I TOLD JAKE THE CALENDAR EFFECT WAS SMALL. IT IS THE BIGGEST RETAIL-CALENDAR DISTORTION I
- `2026-08-15` `L3718` 2026-08-15 ~12:36am PDT — ★★★★★★★ A THIRD INDEPENDENT ROUTE TO THE VAULT'S 30Y CONCLUSION — and it EXTENDS it somewher
- `2026-08-15` `L3808` ✓ VERIFIED SAME TURN (rule 10) — 2026-08-15 ~12:45am PDT
- `2026-08-16` `L3816` 2026-08-16 ~5:46pm PDT — ★★★★★ JAKE: *"Bond yield averages should be part of the inflation calculations."* THE ARGUMEN
- `2026-08-16` `L3878` 2026-08-16 ~7:13pm PDT — ★★★★★★★ THE AUGUST REFUNDING RESULTS CLOSE MY ⬜ FROM 90 MINUTES AGO (**30Y stop = 5.216%**) A
- `2026-08-16` `L3885` DATA (verified arithmetic, 2026-08-16 ~7:13pm PDT)
- `2026-08-16` `L3932` 2026-08-16 ~11:28pm PDT — ★★★★★★ **JGB 2Y AT 1.687%, A 31-YEAR HIGH, IS PART TWO OF A TRAP THE VAULT ALREADY SPECIFIED
- `2026-08-16` `L3938` DATA (MEASURED — `tape.py`-style close-array pulls, 2026-08-16 ~11:28pm PDT)
