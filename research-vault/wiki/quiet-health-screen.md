...
> **7 dated entries · 2026-07-05 → 2026-07-12 · refreshed 2026-08-17 17:01 PDT**
>
...
**2026-07**
- `2026-07-05` `L21` Quiet-Health Screen — S&P 500 value x health x no-story (first run 2026-07-05)
- `2026-07-05` `L30` DATA — EDGAR verification, top 20 (run 2026-07-05, Jake's Colab)
- `2026-07-05` `L42` DATA — full screen output (run 2026-07-05, 503/503 pulled, 0 failed)
- `2026-07-07` `L81` Analyst layer — estimate revisions + targets (Cell 3 run 2026-07-07)
- `2026-07-07` `L105` Live benchmark — the paper basket (started 2026-07-07)
- `2026-07-12` `L119` GEHC — the 8-buyer cluster, detail (2026-07-12, WebSearch corroboration of the NDX scan hit)
- `2026-07-12` `L140` GEHC cluster — COMPLETE FILE (2026-07-12, Jake's EDGAR detail parse, 120d window)
