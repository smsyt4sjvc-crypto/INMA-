...
> **72 dated entries · 2026-07-16 → 2026-08-16 · refreshed 2026-08-17 17:01 PDT**
>
...
**2026-07**
- `2026-07-16` `L161` 2026-07-16 close — the tape discriminates on the CAPEX-GAP (refines the payer/seller call)
- `2026-07-17` `L180` 2026-07-17 (Fri EU pre-open) — TSMC 77% beat SOLD −4%: the January call, on one name, in one session
- `2026-07-17` `L204` 2026-07-17 ~7:20am PT — the RAZOR moment: China "DeepSeek 2.0"; AAPL overtakes NVDA (#1); CXMT correction
- `2026-07-17` `L236` 2026-07-17 ~9:35am PT — the razor cuts WITHIN semis: memory/storage GREEN, compute/GPU RED
- `2026-07-17` `L260` 2026-07-17 ~12:30pm PT — AAPL overhang clears + sell-side piles in; Meta→Anthropic compute lease
- `2026-07-17` `L277` 2026-07-17 — the "Kimi/DeepSeek moment" QUANTIFIED (Goldman China-AI deck; `raw/2026-07-17-goldman-china-ai-ecosystem.
- `2026-07-17` `L318` 2026-07-17 ~8pm PT — the ANTI-circular: Japan's sovereign robotics buy = FRESH external demand (Jake's catch)
- `2026-07-19` `L342` 2026-07-19 ~6pm PT — Open-weight sovereignty vector, PRIMARY-SOURCED (HF agentic-breach disclosure)
- `2026-07-19` `L377` 2026-07-19 ~8:40pm PT — Chinese models = ~50% of US-firm token share on OpenRouter (Bloomberg) — the thesis quantified
- `2026-07-20` `L404` 2026-07-20 ~8am PT — the price FORK quantified (Chamath) + Kimi K3 revives the Trump ban
- `2026-07-20` `L431` 2026-07-20 ~6pm PT — the thread goes MAINSTREAM + POLITICAL (WSJ; the actors name the mechanism)
- `2026-07-21` `L472` 2026-07-21 ~6:48am PT (Tue open) — MU clears the $907 reclaim; chip-bear steamrolled near-term; circular wire INTENSIF
- `2026-07-21` `L494` 2026-07-21 ~7am PT — China RETALIATES: considering AI + semi export controls (the arms race goes two-way)
- `2026-07-21` `L519` 2026-07-21 ~7:25am PT — MSFT tests Kimi K3 in Copilot: the incumbent's incumbent shops OpenAI's replacement
- `2026-07-22` `L555` 2026-07-22 ~7:40am PT — the HF "agentic attacker" was OPENAI'S OWN MODEL (recontextualizes the 7/19 entry) — the guard
- `2026-07-22` `L589` 2026-07-22 ~10am PT — supplement (CoinTelegraph/OpenAI primary source): it's a PATTERN, not a one-off
- `2026-07-22` `L609` 2026-07-22 ~1:10pm PT — refinement (Jake's memory pattern-match): "beat sold on capex" has TWO different mechanisms
- `2026-07-22` `L623` 2026-07-22 ~1:40pm PT — the razor cut BEARISH on the FLAGSHIP: GOOGL −3.85% AH on a $205B capex guide (escape hatch FA
- `2026-07-22` `L643` 2026-07-22 ~3:15pm PT — Jake's razor UPGRADE: it's the MEANS of financing, not the capex number
- `2026-07-22` `L670` 2026-07-22 ~3:20pm PT — supplement (Jake): the CFO undercut the escape hatch — Wiz "to weigh on Cloud profits"
- `2026-07-22` `L684` 2026-07-22 ~3:30pm PT — supplement (Jake): Meta entering cloud = the hyperscalers converging on the MEMORY dynamic
- `2026-07-22` `L701` 2026-07-22 ~3:35pm PT — CFO confirms the margin squeeze IN REAL TIME — but it's SHORTAGE, not glut (yet); payer/seller
- `2026-07-22` `L716` 2026-07-22 ~5:25pm PT (Wed close) — the payer/seller RAZOR fired on the exact names: spenders DOWN on capex, sellers U
- `2026-07-23` `L737` 2026-07-23 ~7:58am PT (Thu) — the $99B illusion CONFIRMED (market stripped it, as called); FY capex 195-205B (from 180
- `2026-07-23` `L755` 2026-07-23 ~8:20am PT — the CAPEX-GAP GAUNTLET (upcoming): the razor's scheduled tests, post-GOOGL
- `2026-07-23` `L769` 2026-07-23 ~1:20pm PT — Intel BEATS (Jake's "earnings are fine" validated) — but it's the EASY name + the razor CONFIR
- `2026-07-24` `L786` 2026-07-24 ~6:20am PT — Token costs at 3.5-MONTH LOWS + Hyperscaler index at lows ("erased the agentic bounce") + chea
- `2026-07-24` `L799` 2026-07-24 ~6:41AM PT — RAZOR REFINEMENT (bullish sellers ON VOLUME, until capex PEAKS) + the MEMORY-CANARY non-confir
- `2026-07-24` `L815` DATA (baseline to grade forward — prices 2026-07-24 AM, Yahoo v8)
- `2026-07-24` `L828` 2026-07-24 ~6:44AM PT — MEMORY-CANARY grade, day 2 (Fri open): MU −4.1% underperforming NVDA −0.4%; payers GREEN
- `2026-07-24` `L835` 2026-07-24 ~9:00AM PT — INTEL round-trip COMPLETE = beat-but-sell CONFIRMED (the "Friday is the referee" call graded)
- `2026-07-24` `L844` 2026-07-24 ~10:48AM PT — JAKE'S TELECOM ANALOGY: metering capitulates, value migrates PIPE → OVER-THE-TOP (the resolut
- `2026-07-24` `L865` 2026-07-24 ~3:16PM PT — ⚠️ CORRECTION (JPM ground-truth): the INTC fade was DILUTION + strategy, NOT the depreciation/
- `2026-07-25` `L876` 2026-07-25 ~6:50pm PT — SAMSUNG–BROADCOM $200B MOU (HBM4/4E + 2nm foundry through 2030): the memory-canary gets a VOLU
- `2026-07-26` `L907` 2026-07-26 ~10:05pm PT — the razor's TERMINAL FORM (Jake): financing is the catalyst; the P&L lost evidentiary value
- `2026-07-26` `L944` 2026-07-26 ~11:55pm PT — DeLong/Kedrosky/Epoch: capability CONVERGENCE chart — the frontier-cadence trigger gets its f
- `2026-07-27` `L1004` 2026-07-27 ~5:50am PT — PRE-MARKET DIGEST INGEST (scanner run 5:34am PT) — CXMT +500% debut, Burry sizes up, passthrou
- `2026-07-27` `L1036` 2026-07-27 ~5:55am PT addendum — the Wednesday setup, sell-side + CFO texture (collector run #1)
- `2026-07-27` `L1044` 2026-07-27 ~6:05am PT — CXMT +466% DEBUT: what a pop actually funds (Jake's question, answered mechanically)
- `2026-07-27` `L1073` 2026-07-27 ~6:15am PT addendum — Jake's sharper version: is the IPO ITSELF even relevant, given they were already back
- `2026-07-27` `L1089` 2026-07-27 ~7:35am PT — DOMESTIC DUV: the tools constraint gets a DISSOLUTION DATE (~2027) — and it lands exactly on t
- `2026-07-27` `L1121` 2026-07-27 ~11:55am PT — MS/Shawn Kim's two-tier memory market (Jake's paste) + Jake's both-ways question: the LTA cap
- `2026-07-27` `L1156` 2026-07-27 ~2:10pm PT addendum — the DUV clock SHORTENS: CXMT slated for domestic DUV deliveries THIS AUGUST + testing
- `2026-07-27` `L1167` 2026-07-27 ~2:50pm PT — THE CLOSE: maximum-dispersion day — the razor's cleanest single-session print yet
- `2026-07-27` `L1186` 2026-07-27 ~8:35pm PT addendum — GOLDMAN'S DESK POST-MORTEM: the vault's three morning threads named as THE session dr
- `2026-07-28` `L1208` 2026-07-28 ~7:50am PT — THE FULL-INDEX SWEEP: 372 UP / 131 DOWN, MEDIAN +1.61% — this is not a down day; it is ONE TRA
- `2026-07-28` `L1241` 2026-07-28 ~8:15am PT — GLW −19%: BEAT-SOLD EXHIBIT #4, the most extreme yet — and a misfile warning (Jake's research)
- `2026-07-28` `L1265` 2026-07-28 ~8:15am PT — MAG-7 RVOL: NVDA's flat is NEITHER pin nor battle — it is ABANDONMENT (the answer to Jake's qu
- `2026-07-28` `L1288` 2026-07-28 ~7:00pm PT — ★ THE AGENT STOLE THE ANSWER KEY — and it CONTAMINATES the vault's own capability instrument
- `2026-07-28` `L1326` 2026-07-28 ~7:40pm PT — ⛔ THE PLATEAU READ NOW HAS A NAMED, SENIOR, CROSS-LAB CONTRADICTION (primary source)
- `2026-07-28` `L1384` 2026-07-28 close ~7:20pm PT — ★★★ SK HYNIX: REVENUE MORE THAN TRIPLED, NET PROFIT +1,242% — AND THE STOCK FELL
- `2026-07-29` `L1385` DATA (Jake's Tuesday-evening collector, 448 items; archived `raw/archive/2026-07-29-0209utc-vault-headlines.csv`)
- `2026-07-29` `L1438` 2026-07-29 ~8:46am PT — ★★★ "MICROSOFT'S MYTHOS KILLER PROVES THE MODEL IS NOT THE PRODUCT" — and the benchmark is the
- `2026-07-29` `L1488` 2026-07-29 ~9:08am PT — INTC Q2 FULL NUMBERS FILED — but the vault's 7/24 read is SHARPER than this summary and stands
- `2026-07-29` `L1538` 2026-07-29 ~10:35pm PT — ★★ JAKE'S APPLE-CXMT CALL GRADED: THE SENATE ISSUES AN ULTIMATUM
- `2026-07-30` `L1573` 2026-07-30 ~3:22pm PT — ★★★ THE RAZOR REFINES AGAIN: it is ACCELERATION, not capex direction
- `2026-07-31` `L1612` 2026-07-31 ~12:05pm PDT — NVDA × KAWASAKI SHIPYARD ROBOTICS: the Japan sovereign buy, two weeks on, with a NAMED custo
- `2026-07-31` `L1656` 2026-07-31 ~1:40pm PDT — ★★★ JAKE'S "GENUINELY DIFFERENT BEASTS" THESIS, TESTED — and the vehicle answers a different 
**2026-08**
- `2026-08-06` `L1706` 2026-08-06 ~3:20pm PDT — JAKE'S SEGMENTATION THESIS, NAMED: the frontier premium needs a PROPRIETARY PRODUCT INSIDE TH
- `2026-08-07` `L1746` 2026-08-07 ~12:30am PDT — ★★★★ THE FUSION: THE MODEL-SPECIFIC ANTIDOTE — the one proprietary product that CANNOT be co
- `2026-08-09` `L1802` 2026-08-09 ~8:15am PDT — CLAUDE CORPS: $150M to seed 1,000 operators into the WILLING segment (Jake: "I'm in lol" — ve
- `2026-08-10` `L1836` 2026-08-10 ~12:20am PDT — ASTRA: the containment arc's beat four — the first formal "cannot rule out CRITICAL" declara
- `2026-08-10` `L1912` 2026-08-10 ~9:55am PDT — THE DEMAND SIDE SPEAKS IN FIDUCIARY LANGUAGE: PINS CEO — closed-model spend is "wasting share
- `2026-08-10` `L1951` 2026-08-10 ~2:00pm PDT — JAKE'S ADDITION TO THE JOBS LEDGER: the buildout as a TRADES ENTRY POINT "for millions of you
- `2026-08-10` `L1991` 2026-08-10 ~6:25pm PDT — THE "OpenAI SAFETY EXODUS" TWEET, VERIFIED: three REAL departures STACKED from three news cyc
- `2026-08-10` `L2043` Addendum 2026-08-10 ~6:35pm PDT — STATUS: UNRESOLVED UNTIL BACKFILLED (Jake: "who Altman hires matters") — and TWO of 
- `2026-08-11` `L2068` 2026-08-11 ~3:25pm PDT — ★★★★ JAKE'S FRAME GRADED: the MECHANISM is right, the LABEL points at the wrong actor — and t
- `2026-08-11` `L2114` 2026-08-11 ~3:30pm PDT — ★★★★★ THE BARBELL: commoditisation socialises the SURPLUS, not the revenue — and it squeezes 
- `2026-08-12` `L2155` 2026-08-12 ~9:00pm PDT — 🎯 JAKE'S THESIS GRADED: "GOOGLE COMES OUT A CLEAR WINNER; TPU IS THE HARD-TO-CATCH ADVANTAGE"
- `2026-08-16` `L2236` 2026-08-16 ~9:38pm PDT — ★★★★★★ JAKE DECODES THE OPEN-SOURCE INCENTIVE, AND HIS OWN CITED EVIDENCE IS **STRONGER AND C
- `2026-08-16` `L2290` 2026-08-16 ~9:50pm PDT — ★★★★★★★ JAKE'S OPENROUTER NUMBERS, VERIFIED AND EXTENDED. **THE CAP TABLE IS THE ARGUMENT: CA
- `2026-08-16` `L2351` 2026-08-16 ~10:07pm PDT — ★★★★★ JAKE FORMALISES OPEN-vs-CLOSED AS **COMMODITIZE-YOUR-COMPLEMENT** AND BUILDS THE LAYER
