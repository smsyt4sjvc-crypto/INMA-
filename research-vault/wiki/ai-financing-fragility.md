...
> **165 dated entries · 2026-05-22 → 2026-08-17 · refreshed 2026-08-17 17:01 PDT**
>
...
**2026-05**
- `2026-05-22` `L231` Burry Part III corroboration + his own hedges (source 2026-05-22, `raw/2026-05-22-burry-heretics-guide-part-3.md`)
**2026-06**
- `2026-06-30` `L6191` DATA (MEASURED — SEC 10-Q, period ended 2026-06-30)
**2026-07**
- `2026-07-03` `L190` DATA (verified — WebSearch 2026-07-03)
- `2026-07-07` `L259` ⚡ 2026-07-07 — the credit leg goes LIVE: ORCL CDS at record
- `2026-07-08` `L270` Counterweight — capacity is LOOSE; the fuse is POLITICAL (2026-07-08, from Jake's Jul-6/7 log)
- `2026-07-10` `L297` 2026-07-10 — hyperscaler paper is now ~9% of ALL IG supply
- `2026-07-10` `L307` 2026-07-10 — S&P cuts ORCL to BBB- (one notch above junk), stable outlook
- `2026-07-12` `L318` 2026-07-12 — MS: private-credit "liquidity stress not translating into solvency risk" (headline)
- `2026-07-13` `L332` 2026-07-13 ~2:45am — "Did Goldman just pop the AI debt bubble" (ZH paywalled; reconstructed from fragments)
- `2026-07-13` `L365` 2026-07-13 ~3am — CONFIRMED: the Papai quote (GS FICC, via Jake)
- `2026-07-13` `L390` 2026-07-13 ~3:15am — Jake's mechanism catch: WHY the buyers struck + where funding migrates
- `2026-07-13` `L407` 2026-07-13 ~3:30am — Papai story fully resolved (Jake's Perplexity pull)
- `2026-07-13` `L426` 2026-07-13 ~1:30pm PT — the Apollo per-company FCF chart: ORCL IS the negative wing, quantified
- `2026-07-14` `L449` 2026-07-14 ~3:20am PT — drawdown-vs-FCF cross-check (Jake's Q, ModestWallet chart)
- `2026-07-14` `L483` 2026-07-14 ~8:25am PT — MAG7 workbook QUANTIFIES the squeeze (Jake's upload, independent build)
- `2026-07-14` `L484` DATA (observed — reported 10-K FCF/capex; see raw/2026-07-14-mag7-fcf-capex-token-workbook.md)
- `2026-07-14` `L508` 2026-07-14 ~10:25pm PT — the FUNDING GAP quantified: $4-8T capex, no FCF, strained credit (ZH cluster)
- `2026-07-15` `L534` 2026-07-15 ~7:14am PT — the financing-fragility thesis PRINTS: hyperscaler credit stress at a RECORD
- `2026-07-15` `L553` 2026-07-15 ~11:51am PT — Slok: hyperscaler bond COVER RATIO 5x (Feb) → below 2x (July)
- `2026-07-17` `L584` 2026-07-17 ~7:20am PT — THE TRIPWIRE FIRES: hyperscaler BOND market carnage (mechanism confirms the vibe)
- `2026-07-19` `L627` 2026-07-19 ~6pm PT — 30Y at 5.06% (highest auction since 2007): AI-debt crowding-out goes MACRO
- `2026-07-19` `L659` 2026-07-19 ~10:25pm PT — Jake's avalanche synthesis: sharpened (CEPI-margin, levered-edge, yen-carry-corners-Fed)
- `2026-07-19` `L687` 2026-07-19 ~10:35pm PT — ⚠️ CORRECTION to the entry above (Jake's pushback; I over-hedged the Mag-7 insulation)
- `2026-07-19` `L713` 2026-07-19 ~10:40pm PT — the levered-edge crack PRINTS: Meta rents excess compute → neoclouds dump 6-10%
- `2026-07-20` `L739` 2026-07-20 ~10:40am PT — private-credit → IG via insurance WRAPPERS (the AIG rhyme): a new channel into pensions
- `2026-07-21` `L772` 2026-07-21 ~7am PT — the credit leg FIRES on a name: Oracle CDS at multi-year high (Jake's "$2TN won't get paid")
- `2026-07-22` `L800` 2026-07-22 ~7:30am PT — the credit leg goes MAINSTREAM + a fresh circular node (AMD→Anthropic $5B)
- `2026-07-22` `L827` 2026-07-22 ~3:50pm PT — the CREDIT LEG fires across names: hyperscaler bonds "slaughtered," SpaceX bonds at JUNK, G-sp
- `2026-07-22` `L857` 2026-07-22 ~4:45pm PT — AMD-Anthropic DETAIL (WSJ): the LEASE BACKSTOP upgrades the wire from correlated to credit-tra
- `2026-07-23` `L872` 2026-07-23 ~10:20am PT — the OFF-BALANCE-SHEET layer: Google $811B contracted commitments (+$500B in ONE quarter); ~$2
- `2026-07-23` `L897` 2026-07-23 ~11:30am PT — the credit leg goes from STRESS to BREAK: investors "refuse to fund memory chip purchases"; b
- `2026-07-23` `L921` 2026-07-23 ~1pm PT — HARD DATA on the credit break: it's DISCRIMINATING (levered periphery breaks, cash-rich core pris
- `2026-07-23` `L945` 2026-07-23 ~8:05pm PT — THE FAILURE-MODE PLUMBING (Jake's 4 questions) + the off-switch is a TRIGGER not a floor
- `2026-07-23` `L993` 2026-07-23 ~8:12PM PT — WHICH cut-signal is worse: SOLVENCY (ROI) vs LIQUIDITY (financing) + the PACE tell (Jake)
- `2026-07-24` `L1018` 2026-07-24 ~6:20am PT — FRAGILITY GOES LOUD on 4 fronts (Fri pre-market scan) — but still WIDEN not SEIZE
- `2026-07-24` `L1042` 2026-07-24 ~6:25AM PT — GOLDMAN full quote: the Beignet SPV crack (Meta) + "revenue inflects before spending peaks" + 
- `2026-07-24` `L1075` 2026-07-24 ~6:35AM PT — ORACLE 5yr CDS record ~203bps (Bloomberg chart) — idiosyncratic WIDEN, junk-cut = the systemic
- `2026-07-24` `L1098` 2026-07-24 ~6:44AM PT — Meta's NEXT datacenter debt raise ($12.3B BlackRock) "could cost MORE than its 2025 record" + 
- `2026-07-24` `L1110` 2026-07-24 ~12:15PM PT — CREDIT LEG charts at RECORD WIDES (3 ZH charts) + Ed Dowd "caution warranted" (consensus-perm
- `2026-07-24` `L1123` 2026-07-24 ~5:23PM PT — BEIGNET SPV G-spread goes VERTICAL to 229bps (ZH chart) — the pace-tell's biggest move, but "b
- `2026-07-24` `L1132` 2026-07-24 ~7:43pm PT — THE PRIVATE-CREDIT TAXPAYER BACKSTOP (Drall & Granato law-review paper) — failure-mode #2 deep
- `2026-07-24` `L1151` 2026-07-24 ~7:56PM PT — THE TATTLE-TELLER SIGNAL (Jake): prudent insurers as motivated informants — and why SILENCE is
- `2026-07-24` `L1158` ⚠️ REFINEMENT (2026-07-24 ~7:59PM PT) — Jake: "they know exactly what's happening, they don't need to extrapolate from
- `2026-07-24` `L1164` 2026-07-24 ~8:48PM PT — JAKE'S SYNTHESIS graded (the AI-capex → PE → insurer → guaranty-fund → taxpayer chain) + the S
- `2026-07-24` `L1172` 2026-07-24 ~8:52PM PT — "What stopped them until now?" (Jake) — the subsidy lay DORMANT 40 years; ZIRP switched it on
- `2026-07-24` `L1182` 2026-07-24 ~8:54PM PT — ⚠️ better question (Jake, I misread first): "what stopped them from just offering higher rates
- `2026-07-24` `L1192` 2026-07-24 ~8:57PM PT — "So it's just risk… but don't they get sued?" (Jake) — NO: state receivership, not bankruptcy;
- `2026-07-24` `L1203` 2026-07-24 ~8:59PM PT — ★ THE "SO WHAT" (Jake: "I'm just confused what the consequence is") — it's a BUFFER, not a BOM
- `2026-07-24` `L1211` 2026-07-24 ~9:03PM PT — ★ "Why WOULDN'T they do it?" (Jake) — DOMINANT STRATEGY + "the risk doesn't feel like risk" (…
- `2026-07-24` `L1217` 2026-07-24 ~9:08PM PT — ★ JAKE'S INVERSION: "NOT blowing up is the higher risk" — MINSKY + fire-suppression (corrects 
- `2026-07-24` `L1225` ⚠️ CORRECTION (2026-07-24 ~9:25pm PT) — "backstop" was the wrong word; it's ONE POOL reallocated, not two pools where 
- `2026-07-24` `L1233` 2026-07-24 ~10:47pm PT — GOOGLE DISCLOSES $94.1B SPACEX STAKE (6%) — the receipt for Wednesday's $99B "gain on equity 
- `2026-07-24` `L1247` 2026-07-24 ~11:06PM PT — SEC-SCANNER first full run (Jake ran it in Colab): the corrected AMZN read = NEGATIVE $72.7B 
- `2026-07-24` `L1259` 2026-07-24 ~11:07PM PT — addendum from Jake's full v1 run: META is the LEAST XBRL-LEGIBLE hyperscaler — and that's the
- `2026-07-24` `L1269` 2026-07-24 ~11:08PM PT — v2 run confirmed clean (Jake, Colab) + one residual: ORCL row now suspect in the OTHER direct
- `2026-07-26` `L1306` 2026-07-26 ~4:03pm PT — THE GOLDEN-WINDOW MATH QUANTIFIED ($725B capex vs $211B depreciation) + GOOGL buyback PAUSE + 
- `2026-07-26` `L1340` 2026-07-26 ~5:38pm PT — THE BIGGEST CIRCLE YET: NVDA to GUARANTEE ~$250B of OpenAI's Ohio lease/debt + finance the $35
- `2026-07-26` `L1377` 2026-07-26 ~5:55pm PT — JAKE'S ECLIPSE SYNTHESIS (graded): the capex shadow reaches the check-cashers; the IPO race wa
- `2026-07-26` `L1412` 2026-07-26 ~6:10pm PT — JAKE PART 2 (graded): everyone was priced as THE winner; the Jevons bet is now priced-beyond-p
- `2026-07-27` `L1446` 2026-07-27 ~5:50am PT — SPACEX CRACKS POST-LISTING: the private-marks thesis printing at the flagship (collector run #
- `2026-07-27` `L1464` 2026-07-27 ~6:25am PT — NVDA→SSI: the purest circular specimen yet + the TPU flip + Jake's "frontloading intent" read
- `2026-07-27` `L1496` 2026-07-27 ~10:45am PT addendum — the SSI number lands: $5 BILLION (ZH relay, as-reported)
- `2026-07-27` `L1513` 2026-07-27 ~2:10pm PT — THE WIDEN-TRIGGER GETS DATA: hyperscaler CDS at RECORD wides, +3bps more, "unprecedented carna
- `2026-07-27` `L1533` 2026-07-27 ~6:45pm PT — THE CREDIT PANEL, WITH NUMBERS (ZH charts via Jake; raw/ x3) — the quality ladder is fully pri
- `2026-07-28` `L1565` 2026-07-28 ~12:15pm PT — ★ THE STEELMAN: the spot-vs-contract repricing bull case (Jake's paste) — the strongest count
- `2026-07-28` `L1633` 2026-07-28 ~1:35pm PT — ★ JAKE'S REFINEMENT: the bear is the MECHANISM (tranching + distribution), not the number — an
- `2026-07-28` `L1685` 2026-07-28 ~1:50pm PT — THE DC-PLAN CHANNEL, VERIFIED (with a correction) + the Bermuda leg: both ends of the distribu
- `2026-07-28` `L1767` 2026-07-28 ~5:10pm PT — ★ THE CHANNEL NARROWS, MEASURED: Asian private-credit fundraising at a decade low — the rate-t
- `2026-07-28` `L1768` DATA (FT / PitchBook chart, `raw/2026-07-28-asia-private-credit-fundraising-ft.png`)
- `2026-07-28` `L1810` 2026-07-28 close ~7:20pm PT — ★★ BANKS HIT SECTOR LIMITS ON DATA-CENTRE LOANS + A ONE-IN-THREE FED HIKE BID
- `2026-07-29` `L1811` DATA (collector CSV 7/29 02:09 UTC, archived `raw/archive/2026-07-29-0209utc-vault-headlines.csv`)
- `2026-07-29` `L1857` 2026-07-29 ~8:45am PT — ★★★ META MOVES CAPEX OFF BALANCE SHEET INTO A BLACKROCK JV — JAKE'S MECHANISM, NAMED AND PRICE
- `2026-07-29` `L1901` 2026-07-29 ~9:06am PT (PRE-FOMC) — ★★★ THE NEOCLOUDS BROKE. ALL SIX, DOUBLE DIGITS, IN ONE SESSION.
- `2026-07-29` `L1950` 2026-07-29 ~2:05pm PT — ★★★ THE RAZOR IS NOT "BEAT-SOLD." IT IS "CAPEX-RAISE-SOLD." SAME NIGHT, TWO NAMES, ONE VARIABL
- `2026-07-29` `L2059` 2026-07-29 ~10:55pm PT — ★★ TWO SPV DEALS IN ONE DAY: the private-credit mechanism this note registered as a MECHANISM
- `2026-07-30` `L2006` 2026-07-30 ~5:35am UTC feed / ~7:00am PT — ★★★ THE RAZOR REFINES AGAIN: IT IS CAPEX **OPTIONALITY**, NOT CAPEX DIRECTI
- `2026-07-30` `L2092` 2026-07-30 ~12:44am PT — ★★ THE PRIMARY-MARKET READ I ASKED FOR ARRIVES, AND IT IS A BROKEN DEAL — plus Meta hints at 
- `2026-07-30` `L2119` 2026-07-30 ~6:30am PT — ★★★ THE OPTIONALITY RAZOR GETS ITS CLEANEST TEST AND CONFIRMS — and it makes F1 MORE urgent, n
- `2026-07-30` `L2145` 2026-07-30 ~10:10am ET — ⚠️ "ARCHEGOS 2.0" (Jake): the supporting document is a 5-day-old TAUNT with no evidence in it
- `2026-07-30` `L2189` 2026-07-30 ~9:20am ET — ★★★ F8 FIRES: THE NAMED CASUALTY IS SITUATIONAL AWARENESS LP — verified, and it is STRESSED, n
- `2026-07-30` `L2243` 2026-07-30 ~9:35am ET — ★★★ BLUE OWL FUNDRAISING SLOWDOWN (BBG, Jake): this is F2 getting information, and it is the S
- `2026-07-30` `L2292` 2026-07-30 ~9:50am ET — ★★★ CITADEL BUYS SITUATIONAL AWARENESS'S STOCK PORTFOLIO (WSJ, via Jake) — a bilateral block s
- `2026-07-30` `L2330` 2026-07-30 ~10:05am ET — ⛔ I SPLIT HAIRS AND JAKE WAS RIGHT: the redemptions had ALREADY happened. But the PRICES inve
- `2026-07-30` `L2386` 2026-07-30 ~10:25am ET — ⛔ THE OBDC II MATERIAL IS FIVE MONTHS OLD: verified to FEBRUARY 19-20, 2026, and the digest p
- `2026-07-30` `L2432` 2026-07-30 ~10:30am ET — ★★★ THE SCALE REVISES: $45bn NAV ON JULY 1, "CRISIS MODE" (WSJ) — and the crisis is NOT the l
- `2026-07-30` `L2482` 2026-07-30 11:00am ET — ⛔ ASSETS TO $10bn FROM $45bn (ZH): I CONFLATED ORDERLY WITH SURVIVABLE, and the concession is 
- `2026-07-30` `L2528` 2026-07-30 ~11:20am ET — ★★ THE SNDK HOLDER SCREEN: SA IS ON IT, and the European delta-one banks are the real tell (B
- `2026-07-30` `L2573` 2026-07-30 ~11:30am ET — ★★★ THE HISTORICAL TAB: EVERY TOP-28 HOLDER ADDED, DEALERS LED, AND SEVEN POSITIONS CAME FROM
- `2026-07-30` `L2623` 2026-07-30 ~11:45am ET — ★★★ THE NEXUS/ANTHROPIC/GOOGLE DEAL IS THE SPV MECHANISM MADE FULLY EXPLICIT — and it is the 
- `2026-07-30` `L2679` 2026-07-30 ~3:22pm PT — ★★★ THE LOOP CLOSES INSIDE A HYPERSCALER'S NET INCOME: AMZN's $53B Anthropic mark
- `2026-07-31` `L2710` 2026-07-31 ~10:30am PDT — ANTHROPIC'S CYBER-EVAL INCIDENTS: the risk is not the breach, it is WHOSE P&L the mark sits 
- `2026-07-31` `L2763` 2026-07-31 ~10:45am PDT — ⛔ THE ENTRY ABOVE WAS WRITTEN WITHOUT THE REGULATORY HISTORY. It is already TWO actions deep
- `2026-07-31` `L2803` 2026-07-31 ~11:00am PDT — ⛔⛔ CORRECTION: THE VAULT ALREADY HAD ALL OF THIS. I searched the WEB and not the VAULT.
- `2026-07-31` `L2837` 2026-07-31 ~2:10pm PDT — ★★★ "DOES A FINANCING BREAK HAVE THE BREADTH TO REACH SPY?" — it reaches SPX iff it reaches D
- `2026-07-31` `L2887` 2026-07-31 ~9:47pm PDT — REUTERS: OPENAI FOUND *MORE* CONTAINMENT ESCAPES — and Trump said "we're looking at controls"
**2026-08**
- `2026-08-01` `L2977` 2026-08-01 ~1:20pm PDT — ⛔ THE YEN INTERVENTION: Jake's 7/19 TELL MOVED — and it may be what sold the long end
- `2026-08-02` `L3039` 2026-08-02 ~3:20pm PDT — ★★★ BIG TECH AS A DURATION-SUPPLY SHOCK: a channel this vault never had
- `2026-08-03` `L3104` 2026-08-03 ~9:15am PDT — THE AI FRAMEWORK ARRIVES **VOLUNTARY AND UNPUBLISHED**
- `2026-08-04` `L3230` 2026-08-04 ~12:10pm PDT — ★★★★ THE FIELD REPORT: SA's filed book was 62% PUTS — the "levered AI long" frame dies on th
- `2026-08-05` `L3355` 2026-08-05 ~8:40am PDT — EISEN'S $3T: the do-not-add error at broadcast scale — and the mainstreaming IS the datum
- `2026-08-05` `L3364` ⟲ AMENDMENT 2026-08-05 ~9:20am PDT — ⛔ THE SA "WRAPPER-CANCELLATION" HYPOTHESIS CORRECTED TO **BETA MISMATCH**
- `2026-08-05` `L3377` 2026-08-05 ~9:55am PDT — ★★★ GOOGLE'S LEADERSHIP RESET + THE DEAN/GHEMAWAT EXIT: the circularity thread extends from C
- `2026-08-05` `L3416` 📌 2026-08-05 ~10:50am PDT — 🚩 FETCH: Market Ear, "Remember hyperscaler CDS spreads?" — chart unseen, not graded
- `2026-08-06` `L3424` 📌 2026-08-06 ~8:30am PDT — OBDC Q2: LOPAREX TO NON-ACCRUAL — the legacy book confesses inside the AI lending machine (
- `2026-08-06` `L3462` 2026-08-06 ~8:40am PDT — ★★★★ THE CREDIT MARKET HAS PRINTED ON THE AI DEBT STACK: CDS record-wides (July), spreads re-
- `2026-08-06` `L3532` 2026-08-06 ~10:40am PDT — ★★★★ THE GS "YOU ARE HERE" CHART: five hyperscalers COMBINED go FCF-NEGATIVE this quarter — 
- `2026-08-06` `L3577` 2026-08-06 ~12:15pm PDT — HANDOFF: the off-BS paper's first mark is STRONG (Meta SPV +3pts/70bp tighter), the PIK pipe
- `2026-08-06` `L3600` 📌 2026-08-06 ~2:35pm PDT — 🚩 HEADLINE-CLASS FLAG: GS reportedly finds "HALF the S&P's 'record' earnings growth is Big 
- `2026-08-07` `L3609` 2026-08-07 ~2:55pm PDT — ★★★★ **THE AI CREDIT BASIS IS BORN AND QUANTIFIED (25bp vs 6bp) — and the "20x synthetic" lin
- `2026-08-08` `L3668` 2026-08-08 ~11:40pm PDT — ★★★ THE CDS TAPE GOES PER-NAME — and the ordering matches the CEPI decomposition, not a unif
- `2026-08-08` `L3713` Addendum 2026-08-08 ~11:45pm PDT — THE CHART BEHIND THE PASTE: assessor RESOLVED, the numbers DATED 7/28, and the past
- `2026-08-09` `L3757` Addendum 2026-08-09 ~12:35pm PDT — SWEEP #1 ON THE CDS TAPE: the origin is NAMED, the fresh print does NOT exist yet —
- `2026-08-10` `L3776` 2026-08-10 ~12:25am PDT — THE CURRENT SOURCE ARRIVES: WSJ's Q2 BDC-filings analysis — strain CONFIRMED in filed number
- `2026-08-10` `L3843` 2026-08-10 ~8:35am PDT — 13F FRIDAY (8/14): PRE-REGISTERING WHAT THE BATCH CAN AND CANNOT SHOW ABOUT THE TRS QUESTION
- `2026-08-10` `L3889` 2026-08-10 ~9:40am PDT — HEADLINE FLASH: "WALL STREET FIRMS, NVIDIA PARTNER ON $500B AI FINANCING DEAL: FT" — and NVDA
- `2026-08-10` `L3941` Addendum 2026-08-10 ~10:45am PDT — JAKE CLOSES THE CIRCLE ON THE $500B ENTRY: NVDA's FOUR ROLES against one counterpar
- `2026-08-10` `L3973` 2026-08-10 ~11:20am PDT — THE SNIPPET DELIVERS THREE OBJECTS: Huang's quote gets its venue, NVDA's OWN 50/50 re-segmen
- `2026-08-10` `L4033` Addendum 2026-08-10 ~12:35pm PDT — THE $500B FETCH RETURNS SAME-DAY (ZH full piece, Jake upload): CONSORTIUM NAMED — a
- `2026-08-10` `L4075` Addendum 2026-08-10 ~12:50pm PDT — WIRE CONFIRMATION + A SECOND PROGRAM: "MORGAN STANLEY TO FACILITATE UP TO $1.5T OVE
- `2026-08-10` `L4118` Addendum 2026-08-10 ~1:00pm PDT — JAKE REBUTS THE REWEIGHTING, AND THE RULE REFINES: "conflicted doesn't mean anything
- `2026-08-10` `L4145` Addendum 2026-08-10 ~1:10pm PDT — JAKE: "this is corroboration — that typically requires GUARANTEES that probably are 
- `2026-08-10` `L4176` ⛔ Correction 2026-08-10 ~1:20pm PDT — JAKE'S WORD WAS "AREN'T" VISIBLE (autocorrect, again) — THE READING INVERTS AND 
- `2026-08-10` `L4205` Addendum 2026-08-10 ~1:40pm PDT — FINK ON TAPE: the convener CONFIRMED, "raise as fast as possible," and the two-ledge
- `2026-08-10` `L4248` Addendum 2026-08-10 ~1:50pm PDT — THE FLOWS-LEDGER PERSONIFIED: retail bull reads the Fink tape ("we did not even star
- `2026-08-10` `L4272` Addendum 2026-08-10 ~2:15pm PDT — HUANG'S HALF OF THE TAPE: $50-60B PER GIGAWATT (the conversion factor), "investable.
- `2026-08-10` `L4327` Addendum 2026-08-10 ~3:45pm PDT — SONNET FETCH #1 RETURNS: both Huang quotes VERBATIM-CONFIRMED (Dwarkesh, April 15 20
- `2026-08-10` `L4365` 2026-08-10 ~4:10pm PDT — THE PRIMARY DOCUMENT LANDS (Huang's X post): THE WRAP GOES VISIBLE AT ≤25% RVG — Jake's test 
- `2026-08-11` `L4442` 2026-08-11 ~7:45am PDT — GRADED: the sign-flip test HELD TO THE CLOSE — and the $2T day closed FLAT
- `2026-08-11` `L4454` 2026-08-11 ~7:45am PDT — ★★★★ REGISTERED ITEM #2 CLOSES FROM THE OTHER SIDE: IBM's CEO PUT A NUMBER ON THE COMPUTE SHA
- `2026-08-11` `L4556` 2026-08-11 ~10:40pm PDT — ★★★★★ THE WSJ PRIMARY ON THE $500B PIPELINE: the mechanism is a RESIDUAL-VALUE GUARANTEE, no
- `2026-08-11` `L4628` 2026-08-11 ~10:55pm PDT — ★★★★★ THE COLLATERAL DISANALOGY, AND WHY THE 25% IS PROBABLY AN ACCOUNTING NUMBER RATHER THA
- `2026-08-11` `L4684` 2026-08-11 ~11:10pm PDT — ★★★★ "IS IT CO-SIGNING? CAN THEY DICTATE THE PROCEEDS? SOUNDS ILLEGAL" — GRADED: wrong on fo
- `2026-08-11` `L4729` 2026-08-11 ~11:20pm PDT — ⛔⛔ JAKE SPLITS "CIRCULAR" FROM "VENDOR FINANCING" AND HE IS RIGHT. This note has been import
- `2026-08-11` `L4778` 2026-08-11 ~11:30pm PDT — ★★★★★ "IT TURNS A SIGNATURE INTO CASH FLOW. WITHOUT ISSUING ANY DEBT." — the whole structure
- `2026-08-12` `L4822` 2026-08-12 ~12:05am PDT — ★★★★ RECEIVER WINDOW #1 GRADED: CRWV's PRINT IS A BACKLOG STORY THE EQUITY MARKET BOUGHT AND
- `2026-08-12` `L4873` 2026-08-12 ~11:55am PDT — ★★★★★ THE $9B PREPAYMENT LINE IS A THIRD FUNDING CHANNEL THIS VAULT HAS NOT BEEN TRACKING — 
- `2026-08-12` `L4921` 2026-08-12 ~9:45pm PDT — ⛔ "CORROBORATION AND HUANG DOUBLES DOWN" — IT IS NOT CORROBORATION. ONE ORIGIN, TWO OUTLETS, 
- `2026-08-12` `L4996` 2026-08-12 ~9:50pm PDT — ★★★★★ REGISTERED ITEM #3 CLOSED: THE A100 RATE CURVE, FETCHED. **I WAS WRONG ABOUT ITS MAGNIT
- `2026-08-12` `L5080` 2026-08-12 ~9:55pm PDT — ★★★★★ JAKE'S QUESTION COLLAPSES THE RATE PROBLEM TO **ONE DISCLOSED NUMBER** — and the identi
- `2026-08-12` `L5145` 2026-08-12 ~10:05pm PDT — ⛔ JAKE SUPPLIES THE **TRANSACTED** ANCHOR I SAID WAS MISSING — and taking it at face value d
- `2026-08-12` `L5207` 2026-08-12 ~10:15pm PDT — ★★★★★ JAKE LINKS META-COMPUTE TO THE RATE CURVE AND ASKS FOR A DEPRECIATION CLIFF. **THE VAU
- `2026-08-12` `L5303` 2026-08-12 ~10:20pm PDT — ⚠️ THE DEMAND-CONSTRAINT EVIDENCE: **ALL THREE NUMBERS WERE ALREADY ON DISK, TWO OF THEM FOR
- `2026-08-12` `L5372` 2026-08-12 ~10:30pm PDT — ★★★★★★ JAKE'S EFFICIENCY CHALLENGE BREAKS MY GRID ARGUMENT AND PRODUCES THE BEST RESULT OF T
- `2026-08-12` `L5445` 2026-08-12 ~10:50pm PDT — ⛔⛔⛔ **I RAN THE FALSIFIER I REGISTERED 15 MINUTES AGO AND IT KILLED MY OWN HEADLINE FINDING.
- `2026-08-12` `L5501` 2026-08-12 ~10:55pm PDT — ⛔ JAKE'S TIMING CLAIM TESTED AGAINST THE ONE REAL SERIES: **MID-2025 IS WHEN H100 PRICES *FE
- `2026-08-12` `L5566` 2026-08-12 ~11:00pm PDT — ★★★★★★ JAKE'S SEGMENTATION POINT BREAKS MY SUBSTITUTION CLIFF — **AND NAMES THE TENANT BASE 
- `2026-08-12` `L5623` 2026-08-12 ~11:05pm PDT — ⚠️ THE HUANG ATTRIBUTION, RESOLVED HONESTLY — and the vault's own disclosure record CONTRADI
- `2026-08-12` `L5671` 2026-08-12 ~11:15pm PDT — ⛔⛔ NO, THE STARTUP LINE IS NOT IN THERE — **AND THIS VAULT INGESTED AND GRADED THIS EXACT TR
- `2026-08-12` `L5728` 2026-08-12 ~11:15pm PDT (cont.) — ⛔ JAKE SOURCES IT HIMSELF: **WSJ, THIS WEEK — "many of his customers can't afford to
- `2026-08-13` `L5775` 2026-08-13 ~12:52pm PDT — ★★★★★★★ **THE IDENTITY RESOLVES, AND IT RESOLVES AGAINST THE HIGH-RATE BRANCH.** Plus the de
- `2026-08-13` `L5862` 2026-08-13 ~12:55pm PDT — ⛔★ **MY PREDICTED SIGNAL IS ABSENT AND THE REAL ONE IS 12× BIGGER.** NVDA's DSO is FALLING —
- `2026-08-13` `L5943` 2026-08-13 ~10:00pm PDT — ★★★★★★ JAKE OPENS A THIRD DEPRECIATION CHANNEL THE VAULT HAS NEVER CONSIDERED: **REGULATORY 
- `2026-08-13` `L6032` 2026-08-13 ~10:10pm PDT — ⛔ **MY OBSTACLE 1 IS DEFEATED, AND ARITHMETIC DOES IT: PUE HAS 9% OF HEADROOM LEFT AT THE FR
- `2026-08-13` `L6038` DATA (REPORTED — industry PUE, verified 2026-08-13 ~10:15pm)
- `2026-08-13` `L6105` 2026-08-13 ~10:26pm PDT — ★★★★★★★ JAKE'S HAMSTER-WHEEL / VERTICAL-CURVE ARGUMENT: the "wolf" insight is a STANDING con
- `2026-08-13` `L6184` 2026-08-13 ~10:52pm PDT — ⛔★★★★★★★ THE DURATION TEST IS RESOLVED AND IT RESOLVES AGAINST THIS THREAD'S STANDING TONE: 
- `2026-08-13` `L6253` 2026-08-13 ~11:05pm PDT — ★★★★★★★ THE ACCOUNTING MOVED OPPOSITE TO THE PHYSICS, IN THE SAME WINDOW: NVDA HALVED ITS PR
- `2026-08-14` `L6345` 2026-08-14 ~3:55pm PDT — ★★★★★★★ THE CAUSALITY INVERTS: THE $500B WAS NOT A LAUNCH, IT WAS A **RESPONSE TO STALLED DEA
- `2026-08-14` `L6409` 2026-08-14 ~4:25pm PDT — ★★★★★★★ IT CANNOT SHOW SITUATIONAL AWARENESS — BUT IT SHOWS SOMETHING BIGGER: **JANE STREET O
- `2026-08-16` `L6474` 2026-08-16 ~9:00pm PDT — ★★★ WSJ PUTS **$3 TRILLION** OF OFF-BALANCE-SHEET AI COMMITMENTS ON THE FRONT PAGE. **JAKE: "
- `2026-08-17` `L6541` 2026-08-17 ~9:10am PDT — ★★★★★★ THE OHIO BACKSTOP IS ~$105B AND IT DOES NOT FIT NVIDIA'S OWN DISCLOSED CAP. ⇒ EITHER T
- `2026-08-17` `L6552` [2026-08-17] **OpenAI + SB Energy + NVIDIA announce the "PORTS-Pike" AI campus, Pike County, Ohio.**
- `2026-08-17` `L6555` [2026-08-17] **Initial backstop exposure reported ~$105B** — *"rather than a simple blanket guarantee of
- `2026-08-17` `L6557` [2026-08-17] Also confirmed in the brief, already vault-held: **Stripe/OpenRouter >$7B** (`compression-thesis:2205`),
- `2026-08-17` `L6615` 2026-08-17 ~9:40am PDT — ⛔⛔★★★★★★ JAKE'S PER-GW QUESTION KILLS MY $420B — **THE VAULT HELD THE DENOMINATOR SINCE 7/26 
