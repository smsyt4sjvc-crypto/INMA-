...
> **12 dated entries · 2026-03-02 → 2026-08-12 · refreshed 2026-08-17 17:01 PDT**
>
...
**2026-03**
- `2026-03-02` `L39` STUDY 1 — After a war ≥0.80% one-day SPX drop (DATA, SPY, since 2026-03-02)
- `2026-03-02` `L50` STUDY 2 — War weekends (DATA, SPY, 21 weekends since 2026-03-02)
**2026-07**
- `2026-07-23` `L62` STUDY 3 — Drawdown-from-ATH ruler (DATA, ^GSPC + ^NDX, 2020→2026-07-23)
- `2026-07-30` `L91` 2026-07-30 ~4:20pm PT — APPLIED: "I just need 2%, that's not uncommon" (Jake) — the base rates, against the claim
- `2026-07-31` `L119` 2026-07-31 ~5:20pm PDT — ★★★ MOVEMENT-CAPTURE SCREEN, RUN 1 (Jake's Colab, 34 names, 2015→)
- `2026-07-31` `L162` 2026-07-31 ~5:45pm PDT — ★★★ RUN 2 (filter fixed): the reclaim filter HURTS the best names, and the EV collides with t
- `2026-07-31` `L213` 2026-07-31 ~6:05pm PDT — ⛔ UNIVERSE ERROR, AND THE FIX: `dip_universe_screen_cell.py`
- `2026-07-31` `L245` 2026-07-31 ~7:55pm PT — RUN 3 GRADED (whole S&P 500) + ⛔ THE NULL WAS A GUESS
- `2026-07-31` `L316` 2026-07-31 ~8:05pm PT — ⛔⛔ THE SCREEN IS DEAD. THE EDGE WAS 100% VOLATILITY CLUSTERING.
**2026-08**
- `2026-08-12` `L386` 2026-08-12 ~5:40pm PDT — ★★★★ JAKE'S PRE-EARNINGS 20-SMA SETUP RUNS: THE MOVE IS BEFORE THE PRINT, NOT AT IT
- `2026-08-12` `L444` Addendum 2026-08-12 ~6:20pm PDT — ⛔⛔ THE v2 RUN REVERSES MY HEADLINE. THE PRINT DOES PAY — ONCE GATED.
- `2026-08-12` `L494` Addendum 2026-08-12 ~6:55pm PDT — ⛔⛔⛔ THE BY-YEAR PANEL KILLS THE INTERACTION. IT WAS 11 EVENTS IN TWO THIN YEARS.
